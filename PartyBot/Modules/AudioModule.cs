...
namespace PartyBot.Modules
{
    ...
    => await ReplyAsync(embed: await AudioService.JumpAsync(Context.User as SocketGuildUser, Context.Guild, Context.User as IVoiceState, Context.Channel as ITextChannel, search));
